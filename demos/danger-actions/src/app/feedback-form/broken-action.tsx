...
function BrokenAction(): ReactElement {
    ...
    return (
      ...
      <h2 className="ml-4 mb-2">Knekk en action</h2>
            <button className="p-2 border bg-red-200" onClick={() => {
            ...
            {result != null ? <div className="mt-2">Resultat: {result}</div> : <div className="mt-2 text-sm">Klikk på knappen da vel</div>}
        </div>
    );
};
